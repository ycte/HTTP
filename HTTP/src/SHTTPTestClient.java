...
//        }
        ...
        clientServer.run();
        SHTTPTestClient.aveTime = (long) (SHTTPTestClient.timeSum * 1.0 / SHTTPTestClient.fileCntNum);
        SHTTPTestClient.aveByte = (long) (SHTTPTestClient.byteSum * 1.0 / TIME_NUM);
        System.out.println("timeSum: " + timeSum);
        System.out.println("the total transaction throughput: " + fileCntNum * 1.0 / TIME_NUM +
                "\ndata rate throughput: " + aveByte +
                "\nthe average of wait time: " + aveTime);
    } // end of main
